...
object SpanishDecks {
    val decks = mapOf(
        ...
        "acting_extended" to Deck(
            id = "acting_extended",
            name = "Actuación (Extenso)",
            category = "General",
            instruction = "No hablar—solo gestos y movimientos corporales",
            words = listOf(
                // Acciones cotidianas
                ...
                "Montar en bicicleta",
                "Hacer trucos en monopatín",
                "Patinar en línea",
                "Saltar la cuerda",
                "Hacer hula hoop",
                "Yoga (perro boca abajo)",
                "Tocar el piano",
                "Tocar la guitarra",
                "Botar el balón de baloncesto",
                "Encestar una canasta",
                "Patear un balón de fútbol",
                "Golpear con un bate de béisbol",
                "Saque de tenis",
                "Swing de golf",
                "Jugar a los bolos",
                "Pescar",
                ...
                "Chef (cocinando en la estufa)",
                "Profesor (escribiendo en la pizarra)",
                "Fotógrafo (tomando una foto)",
                "Doctor (tomando el pulso)",
                "Enfermero (ajustando una vía IV)",
                "Bombero (utilizando la manguera)",
                "Policía (colocando esposas)",
                "Electricista (cambiando una bombilla)",
                "Mecánico (cambiando una llanta)",
                "Artista (pintando un lienzo)",
                "Músico (tocando el violín)",
                "Actor (mímica en el escenario)",
                "Cajero (escaneando productos)",
                "Camarero (llevando una bandeja)",
                "Piloto (volando un avión)",
                "Astronauta (flotando en el espacio)",
                "Científico (mirando por un microscopio)",
                "Panadero (amasando masa)",
                "Dentista (revisando dientes)",
                "Peluquero (cortando cabello)",
                "Paramédico (realizando RCP)",
                "Granjero (ordeñando una vaca)",
                "Obrero de construcción (martillando un clavo)",
                "Bibliotecario (colocando libros)",
                "Juez (golpeando el mazo)",
                "Abogado (mostrando documentos)",
                "Periodista (sosteniendo grabadora)",
                "Taxi (conduciendo un auto)",
                "Entrenador (silbato en la boca)",
                "Panadero (haciendo pan)",
                "Carpintero (usando la sierra)",
                "Fontanero (apretando una tubería)",
                "Electricista (probando cables)",
                "Fotógrafo (revelando película)",
                "Actor (haciendo reverencia)",
                "Bailarín (girando)",
                "Músico (rasgueando guitarra)",
                "Marinero (izando una vela)"
            )
        ),

        "singing_recent" to Deck(
            id = "singing_recent",
            name = "Canciones (Últimos 15 Años)",
            category = "Música",
            instruction = "Canta o tararea la melodía—¡no se permiten letras!",
            words = listOf(
                "Gangnam Style",
                "Despacito",
                "Uptown Funk",
        ...
        "sound_effects_extended" to Deck(
            ...
            name = "Efectos de Sonido (Sin Hablar)",
            category = "General",
            instruction = "Haz el efecto de sonido—¡no hables!",
            words = listOf(
                // Animales
                "Gato ronroneando",
                "Perro ladrando",
