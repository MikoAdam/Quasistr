...
object FrenchDecks {
    val decks = mapOf(
        ...
        "acting_extended" to Deck(
            id = "acting_extended",
            name = "Jeu d'acteur (Étendu)",
            category = "Général",
            instruction = "Pas de mots—utilisez uniquement des gestes et des mouvements du corps",
            words = listOf(
                ...
                "Faire du vélo",
                "Monter sur une planche à roulettes",
                "Patiner en ligne",
                "Sauter à la corde",
                "Faire du hula hoop",
                ...
                "Truc en skateboard",
                // Métiers & professions
                "Chef (cuisinant sur une cuisinière)",
                "Professeur (écrivant au tableau)",
                "Photographe (prenant une photo)",
                "Docteur (vérifiant le pouls)",
                "Infirmier (ajustant une perfusion)",
                "Pompier (utilisant une lance à incendie)",
                "Policier (mettant des menottes)",
                "Électricien (changeant une ampoule)",
                "Mécanicien (changeant un pneu)",
                "Artiste (peignant sur une toile)",
                "Musicien (jouant du violon)",
                "Acteur (mimiques sur scène)",
                "Caissier (scannant des articles)",
                "Serveur (portant un plateau)",
                "Pilote (pilotant un avion)",
                "Astronaute (flottant dans l’espace)",
                "Scientifique (regardant dans un microscope)",
                "Boulanger (pétrissant de la pâte)",
                "Dentiste (examinant des dents)",
                "Coiffeur (coupant des cheveux)",
                "Paramédical (pratiquant la RCR)",
                "Agriculteur (traire une vache)",
                "Ouvrier du bâtiment (enfonçant un clou)",
                "Bibliothécaire (rangeant des livres)",
                "Juge (frappant son marteau)",
                "Avocat (montrant des documents)",
                "Journaliste (tenant un dictaphone)",
                "Chauffeur de taxi (tenant le volant)",
                "Entraîneur (soufflant dans un sifflet)",
                "Boulanger (faisant du pain)",
                "Charpentier (utilisant une scie)",
                "Plombier (serrant un tuyau)",
                "Électricien (testant des fils)",
                "Photographe (développant un film)",
                "Acteur (s’inclinant)",
                "Danseur (faisant une pirouette)",
                "Musicien (grattant une guitare)",
                "Marin (hissant une voile)"
            )
        ),

        "singing_recent" to Deck(
            id = "singing_recent",
            name = "Chansons (15 Dernières Années)",
            category = "Musique",
            instruction = "Chantez ou fredonnez la mélodie—aucune parole autorisée !",
            words = listOf(
                "Gangnam Style",
                "Despacito",
                "Uptown Funk",
        ...
        "sound_effects_extended" to Deck(
            ...
            name = "Effets Sonores (Sans Paroles)",
            category = "Général",
            instruction = "Faites l’effet sonore—aucune parole autorisée !",
            words = listOf(
                // Animaux
                "Chat ronronnant",
                "Chien aboyant",
                ...
                "Eau bouillante",
                "Compacteur à ordures",
                "Lave-linge en cycle",
                "Micro-ondes bipant",
                "Lave-vaisselle en rinçage",
                // Véhicules & machines
