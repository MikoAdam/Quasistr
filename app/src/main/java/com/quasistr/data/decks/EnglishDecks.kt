    ...
    val decks = mapOf(
        ...
        "acting_extended" to Deck(
            ...
            words = listOf(
                ...
                "Photographer (Developing Film)",
                "Actor (Taking a Bow)",
                "Dancer (Performing Pirouette)",
                "Musician (Strumming Guitar)",
                "Sailor (Hoisting a Sail)"
            )
        ),

        "singing_recent" to Deck(
            id = "singing_recent",
            name = "Songs (Last 15 Years)",
            category = "Music",
            instruction = "Sing or hum the melody—no lyrics allowed!",
            words = listOf(
                "Gangnam Style",
                "Despacito",
                "Uptown Funk",
        ...
        "sound_effects_extended" to Deck(
            ...
            name = "Sounds (No Talking)",
            category = "General",
            instruction = "Make the sound effect—no words or speaking!",
            words = listOf(
                // Animals
                "Cat Purring",
                "Dog Barking",
